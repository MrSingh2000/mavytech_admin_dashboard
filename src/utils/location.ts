export const LOCATIONS = {
  ...
  Brunei: ['Brunei-Muara', 'Belait', 'Tutong', 'Limbang'],
  Bulgaria: [
    'Blagoevgrad',
    'Burgas',
    'Dobrich',
  ...
  Kuwait: ['Ahmadi', 'Al Asimah', 'Al Jahra', 'Hawalli', 'Mubarak Al-Kabeer'],
  Kyrgyzstan: [
    'Batken',
    'Bishkek',
    'Chuy',
  ...
  Monaco: ['Monaco-Ville', 'Monte Carlo', 'La Condamine', 'Moneghetti'],
  Mongolia: [
    'Arhangai',
    'Bayan-Ölgii',
    'Bayankhongor',
