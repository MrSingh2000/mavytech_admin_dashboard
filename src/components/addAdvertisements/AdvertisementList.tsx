    ...
    <div className="container">
      <div className="flex-1 py-8 ">
        <div className="px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8">
          <div
            className="inline-block min-w-full overflow-scroll rounded-lg shadow"
            style={{
              height: '30rem',
              overflowY: 'scroll',
              scrollbarWidth: 'none',
          ...
          >
            ...
            {advertisements && advertisements.length == 0 ? (
              <NoData text="No advertisements available" />
            ) : null}
          </div>
        </div>
      </div>
  ...
  return (
    <tr className="w-full">
      ...
      <td className="pl-5 pr-2 py-5 text-sm bg-white border-b border-gray-200">
        ...
        >
          {data.targetCountry &&
            data.targetCountry.map((item) => (
              <span className="bg-gray-100 text-gray-800 text-xs h-5 font-medium me-2 mt-1 px-2.5 py-0.5 trunacte text-nowrap overflow-ellipsis rounded-full dark:bg-gray-700 dark:text-gray-300">
                {item}
              </span>
            ))}
        </div>
      ...
      <td className="py-5 pl-5 pr-2 text-sm bg-white border-b border-gray-200">
        ...
        >
          {data.targetCity &&
            data.targetCity.map((item) => (
              <span className="bg-gray-100 text-gray-800 h-5 text-xs font-medium me-2 mt-1 px-2.5 py-0.5 rounded-full trunacte text-nowrap overflow-ellipsis dark:bg-gray-700 dark:text-gray-300">
                {item}
              </span>
            ))}
        </div>
      ...
      <td className="px-5 py-5 text-sm bg-white border-b border-gray-200 ">
        <div
          ...
          className={`w-fit text-sm m-auto rounded-3xl px-4 py-1 text-center cursor-pointer ${
            isActive
